/**
 * Initializes level 10 of the game.
...
function initLevel10() {
    ...
    level1 = new Level(
        [
            ...
            new ChickenSmall(4000, 11),
            new ChickenSmall(4400, 11),
            new ChickenSmall(2100, 10),
            new ChickenSmall(2800, 10),
            new ChickenSmall(4900, 12),
            new ChickenSmall(6000, 12),
            ...
            new Chicken(20000, 30),
            new Chicken(25000, 30),
            new Chicken(30000, 30),
            new Chicken(35000, 30),
            new Chicken(20000, 31),
            new Chicken(25000, 31),
            new Chicken(20000, 31),
            new Chicken(25000, 32),
            new Chicken(20000, 32),
            new Chicken(25000, 29),
            new Chicken(20000, 29),
            new Chicken(22000, 28),
            new Chicken(24000, 27),
            new Chicken(28000, 27),
            new Chicken(21000, 30),
            new Chicken(28000, 30),
            new Chicken(28900, 30),
            new Chicken(29100, 30),
            new Chicken(21100, 30),
            new Chicken(21120, 30)
        ],
        [
